...
const Navbar = ({ isTransparent }) => {
  ...
  // Function to handle the Apply Now click
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-4xl bg-white rounded-[30px] shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <button 
              ...
              className="absolute top-4 right-6 text-3xl font-black text-black hover:text-sweet-pink z-10 cursor-pointer"
            >
              ✕
            </button>
...
// Sub-component to load the Script tag safely
const JotFormEmbed = () => {
  useEffect(() => {
  ...
  return <div id="jotform-container" className="min-h-[500px]"></div>;
};
